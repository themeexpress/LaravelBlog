...
<!-- header -->
				...
				<div class="wthree-top">
					<div class="w3agile-top">
						<div class="w3agile_special_deals_grid_left_grid">
							<a href="singlepage.html"><img src="{{asset('public/frontend/images/4.jpg')}}" class="img-responsive" alt="" /></a>
						</div>
				...
				<div class="wthree-top-1">
					...
					<div class="flexslider">
						<ul class="slides">
							<li>
								<div class="w3agile_special_deals_grid_left_grid">
									<a href="singlepage.html"><img src="{{asset('public/frontend/images/2.jpg')}}" class="img-responsive" alt="" /></a>
								</div>
							</li>
							<li>
								<div class="w3agile_special_deals_grid_left_grid">
									<a href="singlepage.html"><img src="{{asset('public/frontend/images/3.jpg')}}" class="img-responsive" alt="" /></a>
								</div>
							</li>
							<li>
								<div class="w3agile_special_deals_grid_left_grid">
			...
			<!-- //flexSlider -->
				...
				<div class="wthree-top-1">
					...
					<div class="col-md-6 w3-lft">
						<div class="w3agile_special_deals_grid_left_grid">
							<a href="singlepage.html"><img src="{{asset('public/frontend/images/5.jpg')}}" class="img-responsive" alt="" /></a>
						</div>
					</div>
					<div class="col-md-6 w3-rgt">
						<div class="w3-rgt-top">
							<div class="w3agile_special_deals_grid_left_grid">
								<a href="singlepage.html"><img src="{{asset('public/frontend/images/g6.jpg')}}" class="img-responsive" alt="" /></a>
							</div>
						</div>
						<div class="w3-rgt-top1">
							<div class="w3agile_special_deals_grid_left_grid">
								<a href="singlepage.html"><img src="{{asset('public/frontend/images/g8.jpg')}}" class="img-responsive" alt="" /></a>
							</div>
						</div>
					</div>
					<div class="clearfix"></div>
	...
	<div class="copyright">
		<div class="container">
			...
			<div class="agileinfo">
				<p>© 2018 Fashion Blog . All Rights Reserved.</p>
			</div>
		</div>
	</div>
<!-- //copyright -->
